...
;;;
;;; $Id: proc.lisp,v 1.4 2005/05/22 07:07:58 dvd Exp $
;;; $Source: /home/dvd/srv/CVSROOT/CL-UTILS/port/proc.lisp,v $
;;;
...
(defmacro with-lock ((lock) &rest body)
  ...
  #+(and MCL (not OpenMCL))
               `(ccl:with-process-enqueued (,lock) ,@body)
